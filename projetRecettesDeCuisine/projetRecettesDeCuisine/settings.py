...
SECRET_KEY = 'li+a5oabe2=o#m#eq#$hf%sfi=9#q!@1wj(zaqw@d!7(c@6!sp'
...
# A décommenter si on veut utiliser un dossier static à la racine du projet
#STATICFILES_DIRS = (
...
STATIC_ROOT = os.path.dirname(os.path.dirname(__file__))+'/staticfiles'
